                    ...
                    <Popover>
                        ...
                        <PopoverContent className="bg-zinc-900 border-zinc-600 text-zinc-200 w-72">
                            ...
                            <ul className="list-disc pl-4">
                                <li>
                                    Access to buildings and rooms may vary depending on faculty or department
                                </li>
                                <li>
                                    Availability is based on officially published class timetables
                                </li>
                                <li>
                                    Some spaces may still be in use for unofficial meetings or group study
                                </li>
                                <li>
                                    Select a building marker to see detailed room schedules
                                </li>
                                </ul>
                        </PopoverContent>
                    </Popover>
